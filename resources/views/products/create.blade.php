			...
			<section id="main" class="clearfix ad-details-page">
					<div class="container">
						...
						<div class="adpost-details">
							<div class="row">	
								<div class="col-md-8">
									<form class="form-horizontal" method="POST" action="/ProductForm" enctype="multipart/form-data">
									{{ csrf_field() }}
										<fieldset>
											...
											@endif
												...
												<div class="row form-group brand-name">
													...
													<div class="col-sm-9">
														<input type="text" name="productname"class="form-control" placeholder="ex, Sony Xperia" required>
											...
											@endif
												...
												<div class="row form-group item-description">
													...
													<div class="col-sm-9">
														<textarea class="form-control" name="description" id="description" placeholder="Write few lines about your products" rows="8" required></textarea>
